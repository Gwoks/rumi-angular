// Production environment configuration using .env file
export const environment = {
  production: true,
  apiUrl: (process.env as any)['NG_APP_API_URL'] || 'https://api.rumi.id',
  ...
  maxFileSize: (process.env as any)['NG_APP_MAX_FILE_SIZE'] || '10MB'
};
